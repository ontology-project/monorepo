...
def import_curriculum_PEO(excel_file):
    ...
    for index, row in df.iterrows():
        ...
        nqf_auth_resp = str(row['KKNI wewenang & tanggung jawab']) if str(row['KKNI wewenang & tanggung jawab']) != "nan" else ""
        ...
        nqf_working_skill = str(row['KKNI Kemampuan bidang kerja']) if str(row['KKNI Kemampuan bidang kerja']) != "nan" else ""
